...
test_statistic <- abs(treatment_avg-control_avg) # definition 


# apply function to check 
apply(perms, 1, function(x) (x == c(0, 1, 0, 0, 0, 1, 1, 1)))

# count the # match treatment 
...
#Q2 return test statistic that matches the treatment 
...
# collecting data into data frame 
...
# average treatment ATE by definition 
